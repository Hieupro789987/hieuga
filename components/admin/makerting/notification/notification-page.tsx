    ...
    <Card>
      ...
      >
        ...
        <DataTable.Consumer>
          {({ formItem }) => (
            <>
              <NotificationForm notification={formItem} />
            </>
          )}
        </DataTable.Consumer>
        <Form
...
function NotificationForm(props: PropsType) {
  return (
    <DataTable.Form grid>
      <Field label="Tiêu đề" name="title" cols={12} required>
        <Input />
      </Field>
      <Field label="Nội dung" name="body" cols={12} required>
        <Textarea rows={2} />
      </Field>
